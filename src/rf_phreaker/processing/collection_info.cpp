...
rf_phreaker::time_type umts_sweep_collection_info::time_ns__ = milli_to_nano(30);
...
rf_phreaker::frequency_type lte_sweep_collection_info::sampling_rate__ = khz(4875); //khz(3840);
...
rf_phreaker::frequency_type lte_layer_3_collection_info::sampling_rate__ = khz(4875); //khz(3840);
