...
public:
	cali_holder() {
		...
		rf_adj.path_.high_freq_ = mhz(230);
		rf_adj.spacing_ = mhz(10);
		rf_adj.rf_adjustments_.push_back(10.1);
		rf_adj.rf_adjustments_.push_back(20.2);
		rf_adj.rf_adjustments_.push_back(30.3);
		...
		path_adj.adj_.path_.low_freq_ = mhz(300);
		path_adj.adj_.path_.high_freq_ = mhz(330);
		cal_.rf_board_adjustments_.insert(std::make_pair(path_adj.identifier_, path_adj));
