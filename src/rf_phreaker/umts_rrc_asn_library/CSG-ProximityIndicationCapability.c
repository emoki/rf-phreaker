...
static asn_TYPE_tag2member_t asn_MAP_CSG_ProximityIndicationCapability_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportOfIntraFreqProximityIndication at 11477 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* supportOfInterFreqProximityIndication at 11478 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* supportOfE-UtraProximityIndication at 11479 */
};
