...
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapability_v590ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-CapabilityWithSimultaneousHS-DSCHConfig at 13437 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pdcp-Capability-r5-ext at 13438 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* rlc-Capability-r5-ext at 13439 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* physicalChannelCapability at 13440 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* multiModeRAT-Capability-v590ext at 13442 */
};
