...
#include "rf_phreaker/umts_rrc_asn_library/DedicatedDynamicTF-Info-DynamicTTI.h"
...
static asn_TYPE_tag2member_t asn_MAP_rlc_Size_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* bitMode at 15040 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* octetModeType1 at 15042 */
};
...
static asn_TYPE_tag2member_t asn_MAP_DedicatedDynamicTF_Info_DynamicTTI_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rlc-Size at 15040 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* numberOfTbSizeAndTTIList at 15043 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* logicalChannelList at 15045 */
};
