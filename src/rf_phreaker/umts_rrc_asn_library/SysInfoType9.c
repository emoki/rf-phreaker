...
#include "rf_phreaker/umts_rrc_asn_library/SysInfoType9.h"
...
static asn_TYPE_tag2member_t asn_MAP_SysInfoType9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dummy at 29851 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 29853 */
};
