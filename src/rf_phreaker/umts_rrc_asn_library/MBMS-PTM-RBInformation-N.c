...
#include "rf_phreaker/umts_rrc_asn_library/MBMS-PTM-RBInformation-N.h"
...
static asn_TYPE_tag2member_t asn_MAP_MBMS_PTM_RBInformation_N_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* shortTransmissionID at 30882 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* logicalChIdentity at 30883 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* layer1-CombiningStatus at 30884 */
};
