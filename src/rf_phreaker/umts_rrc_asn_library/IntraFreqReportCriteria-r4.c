...
#include "rf_phreaker/umts_rrc_asn_library/IntraFreqReportCriteria-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_IntraFreqReportCriteria_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqReportingCriteria at 25116 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* periodicalReportingCriteria at 25117 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* noReporting at 25119 */
};
