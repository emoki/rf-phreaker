...
#include "rf_phreaker/umts_rrc_asn_library/DL-AM-RLC-Mode.h"
...
static asn_TYPE_tag2member_t asn_MAP_DL_AM_RLC_Mode_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* inSequenceDelivery at 13675 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* receivingWindowSize at 13676 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dl-RLC-StatusInfo at 13678 */
};
