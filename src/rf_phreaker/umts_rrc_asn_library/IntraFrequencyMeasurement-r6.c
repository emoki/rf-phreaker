...
#include "rf_phreaker/umts_rrc_asn_library/IntraFrequencyMeasurement-r6.h"
...
static asn_TYPE_tag2member_t asn_MAP_IntraFrequencyMeasurement_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqCellInfoList at 25215 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* intraFreqMeasQuantity at 25216 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* intraFreqReportingQuantity at 25217 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* measurementValidity at 25218 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* reportCriteria at 25221 */
};
