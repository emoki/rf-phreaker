...
static asn_TYPE_tag2member_t asn_MAP_SRNC_RelocationInfo_v3d0ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uESpecificBehaviourInformation1idle at 31940 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* uESpecificBehaviourInformation1interRAT at 31941 */
};
