...
static asn_TYPE_tag2member_t asn_MAP_CN_DomainInformationFull_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cn-DomainIdentity at 10759 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cn-DomainSpecificNAS-Info at 10760 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cn-DRX-CycleLengthCoeff at 10762 */
};
