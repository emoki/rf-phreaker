...
#include "rf_phreaker/umts_rrc_asn_library/PDSCH-Info-LCR-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_PDSCH_Info_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tfcs-ID at 19548 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* commonTimeslotInfo at 19549 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* pdsch-TimeslotsCodes at 19550 */
};
