...
static asn_TYPE_tag2member_t asn_MAP_referenceTime_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* utran-GANSSReferenceTimeResult at 27635 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ganssReferenceTimeOnly at 27637 */
};
...
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_MeasuredResults_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* referenceTime at 27635 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ganssGenericMeasurementInfo at 27639 */
};
