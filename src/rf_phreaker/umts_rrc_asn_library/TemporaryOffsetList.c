...
#include "rf_phreaker/umts_rrc_asn_library/TemporaryOffsetList.h"
...
static asn_TYPE_tag2member_t asn_MAP_TemporaryOffsetList_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* temporaryOffset1 at 26933 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* temporaryOffset2 at 26935 */
};
