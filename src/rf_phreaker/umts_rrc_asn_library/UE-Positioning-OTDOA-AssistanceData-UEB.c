...
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_OTDOA_AssistanceData_UEB_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-positioning-OTDOA-ReferenceCellInfo-UEB at 28219 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ue-positioning-OTDOA-NeighbourCellList-UEB at 28221 */
};
