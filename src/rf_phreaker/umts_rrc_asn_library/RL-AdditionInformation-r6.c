...
#include "rf_phreaker/umts_rrc_asn_library/RL-AdditionInformation-r6.h"
...
static asn_TYPE_tag2member_t asn_MAP_dl_dpchInfo_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-DPCH-InfoPerRL at 20279 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dl-FDPCH-InfoPerRL at 20281 */
};
...
static asn_TYPE_tag2member_t asn_MAP_RL_AdditionInformation_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCPICH-Info at 20276 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cell-Id at 20277 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* dl-dpchInfo at 20279 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* e-HICH-Information at 20282 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* e-RGCH-Information at 20283 */
};
