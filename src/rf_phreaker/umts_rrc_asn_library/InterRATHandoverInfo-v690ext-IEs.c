...
static asn_TYPE_tag2member_t asn_MAP_InterRATHandoverInfo_v690ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-SecurityInformation2 at 3495 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ue-RadioAccessCapabilityComp at 3496 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ue-RadioAccessCapabilityComp2 at 3498 */
};
