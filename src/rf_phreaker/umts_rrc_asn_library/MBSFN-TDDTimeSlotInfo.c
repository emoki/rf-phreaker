...
#include "rf_phreaker/umts_rrc_asn_library/MBSFN-TDDTimeSlotInfo.h"
...
static asn_TYPE_tag2member_t asn_MAP_MBSFN_TDDTimeSlotInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* timeSlotNumber at 31114 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellParametersID at 31116 */
};
