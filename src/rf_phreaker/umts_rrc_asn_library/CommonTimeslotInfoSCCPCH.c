...
static asn_TYPE_tag2member_t asn_MAP_CommonTimeslotInfoSCCPCH_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondInterleavingMode at 16382 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tfci-Coding at 16383 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* puncturingLimit at 16384 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* repetitionPeriodLengthAndOffset at 16385 */
};
