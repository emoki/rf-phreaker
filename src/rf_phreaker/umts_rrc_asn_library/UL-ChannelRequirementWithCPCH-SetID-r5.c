...
#include "rf_phreaker/umts_rrc_asn_library/UL-ChannelRequirementWithCPCH-SetID-r5.h"
...
static asn_TYPE_tag2member_t asn_MAP_UL_ChannelRequirementWithCPCH_SetID_r5_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-DPCH-Info at 21417 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dummy1 at 21420 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dummy2 at 21422 */
};
