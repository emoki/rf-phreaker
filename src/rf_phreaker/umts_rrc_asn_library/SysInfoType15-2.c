...
#include "rf_phreaker/umts_rrc_asn_library/SysInfoType15-2.h"
...
static asn_TYPE_tag2member_t asn_MAP_SysInfoType15_2_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transmissionTOW at 30191 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* satID at 30192 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* ephemerisParameter at 30193 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* nonCriticalExtensions at 30195 */
};
