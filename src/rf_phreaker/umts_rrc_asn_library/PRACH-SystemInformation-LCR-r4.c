...
#include "rf_phreaker/umts_rrc_asn_library/PRACH-SystemInformation-LCR-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_PRACH_SystemInformation_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* prach-RACH-Info-LCR at 19853 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rach-TransportFormatSet-LCR at 19854 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* prach-Partitioning-LCR at 19855 */
};
