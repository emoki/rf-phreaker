...
#include "rf_phreaker/umts_rrc_asn_library/UL-CCCH-Message.h"
...
static asn_TYPE_tag2member_t asn_MAP_UL_CCCH_Message_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* integrityCheckInfo at 242 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* message at 244 */
};
