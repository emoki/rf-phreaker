...
#include "rf_phreaker/umts_rrc_asn_library/DL-RLC-Mode-r5.h"
...
static asn_TYPE_tag2member_t asn_MAP_DL_RLC_Mode_r5_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-AM-RLC-Mode at 13749 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dl-UM-RLC-Mode at 13750 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dl-TM-RLC-Mode at 13752 */
};
