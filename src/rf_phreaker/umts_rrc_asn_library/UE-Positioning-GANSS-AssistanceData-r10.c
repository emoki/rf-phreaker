...
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_AssistanceData_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-positioning-GANSS-ReferenceTime at 27566 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* uePositioningGanssReferencePosition at 27567 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* uePositioningGanssIonosphericModel at 27568 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* uePositioningGanssAddIonoModel at 27569 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* uePositioningGanssEarthOrientationPara at 27571 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* ganssGenericDataList at 27572 */
};
