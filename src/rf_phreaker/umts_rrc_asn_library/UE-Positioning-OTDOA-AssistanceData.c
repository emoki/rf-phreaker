...
#include "rf_phreaker/umts_rrc_asn_library/UE-Positioning-OTDOA-AssistanceData.h"
...
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_OTDOA_AssistanceData_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-positioning-OTDOA-ReferenceCellInfo at 28193 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ue-positioning-OTDOA-NeighbourCellList at 28195 */
};
