...
#include "rf_phreaker/umts_rrc_asn_library/MBMS-PhyChInformation-IMB384.h"
...
static asn_TYPE_tag2member_t asn_MAP_MBMS_PhyChInformation_IMB384_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mbms-CommonPhyChIdentity at 30833 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* secondaryCCPCHInfo-MBMS at 30835 */
};
