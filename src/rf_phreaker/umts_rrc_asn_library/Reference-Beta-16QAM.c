...
#include "rf_phreaker/umts_rrc_asn_library/Reference-Beta-16QAM.h"
...
static asn_TYPE_tag2member_t asn_MAP_Reference_Beta_16QAM_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* reference-Code-Rate at 20170 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* reference-Beta at 20171 */
};
