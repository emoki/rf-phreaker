...
static asn_TYPE_tag2member_t asn_MAP_DTX_E_DCH_TTI_10ms_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-dtx-Cycle1-10ms at 17691 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ue-dtx-Cycle2-10ms at 17692 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* mac-dtx-Cycle-10ms at 17694 */
};
