...
//#include <rf_phreaker/umts_rrc_asn_library/unistd.h>	/* for getopt(3) */
#include <string.h>	/* for strerror(3) */
//#include <rf_phreaker/umts_rrc_asn_library/sysexits.h>	/* for EX_* exit codes */
#include <errno.h>	/* for errno */
#include "rf_phreaker/umts_rrc_asn_library/BCCH-BCH-Message.h"
#include <conio.h>

#include <rf_phreaker/umts_rrc_asn_library/asn_application.h>
#include <rf_phreaker/umts_rrc_asn_library/asn_internal.h>	/* for _ASN_DEFAULT_STACK_MAX */

/* Convert "Type" defined by -DPDU into "asn_DEF_Type" */
//#define	ASN_DEF_PDU(t)	asn_DEF_ ## BCCH_BCH_Message 
 ...
 */
static void *data_decode_from_file(asn_TYPE_descriptor_t *asnTypeOfPDU, FILE *file, const char *name, ssize_t suggested_bufsize, int first_pdu);
...
int main(int ac, char *av[]) {
	...
	void *structure;
	char *name = "wcmda_bit_stream_with_cellid.per";
