...
static asn_TYPE_tag2member_t asn_MAP_MeasurementOccasionPatternParameter_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measurement-Occasion-Coeff at 25777 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* measurement-Occasion-Offset at 25778 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* measurement-Occasion-Length at 25779 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* timeslotBitmap at 25780 */
};
