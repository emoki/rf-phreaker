...
#include "rf_phreaker/umts_rrc_asn_library/UE-RadioAccessCapabBandFDD.h"
...
static asn_TYPE_tag2member_t asn_MAP_fddRF_Capability_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-PowerClass at 13270 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* txRxFrequencySeparation at 13272 */
};
...
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapabBandFDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* radioFrequencyBandFDD at 13268 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* fddRF-Capability at 13270 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* measurementCapability at 13274 */
};
