...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_24 = {
	sizeof(struct CellUpdate__laterNonCriticalExtensions__v590NonCriticalExtensions__v690NonCriticalExtensions__v6b0NonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct CellUpdate__laterNonCriticalExtensions__v590NonCriticalExtensions__v690NonCriticalExtensions__v6b0NonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_vaxyNonCriticalExtensions_22[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellUpdate__laterNonCriticalExtensions__v590NonCriticalExtensions__v690NonCriticalExtensions__v6b0NonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions, cellUpdate_vaxyext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_CellUpdate_vaxyext_IEs,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"cellUpdate-vaxyext"
		},
	{ ATF_POINTER, 1, offsetof(struct CellUpdate__laterNonCriticalExtensions__v590NonCriticalExtensions__v690NonCriticalExtensions__v6b0NonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static int asn_MAP_vaxyNonCriticalExtensions_oms_22[] = { 1 };
static ber_tlv_tag_t asn_DEF_vaxyNonCriticalExtensions_tags_22[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_vaxyNonCriticalExtensions_tag2el_22[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellUpdate-vaxyext at 1459 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 1460 */
};
static asn_SEQUENCE_specifics_t asn_SPC_vaxyNonCriticalExtensions_specs_22 = {
	sizeof(struct CellUpdate__laterNonCriticalExtensions__v590NonCriticalExtensions__v690NonCriticalExtensions__v6b0NonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions),
	offsetof(struct CellUpdate__laterNonCriticalExtensions__v590NonCriticalExtensions__v690NonCriticalExtensions__v6b0NonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions, _asn_ctx),
	asn_MAP_vaxyNonCriticalExtensions_tag2el_22,
	2,	/* Count of tags in the map */
	asn_MAP_vaxyNonCriticalExtensions_oms_22,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_vaxyNonCriticalExtensions_22 = {
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_vaxyNonCriticalExtensions_tags_22,
	sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_22)
		/sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_22[0]) - 1, /* 1 */
	asn_DEF_vaxyNonCriticalExtensions_tags_22,	/* Same as above */
	sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_22)
		/sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_22[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_vaxyNonCriticalExtensions_22,
	2,	/* Elements count */
	&asn_SPC_vaxyNonCriticalExtensions_specs_22	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_v860NonCriticalExtensions_20[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CellUpdate__laterNonCriticalExtensions__v590NonCriticalExtensions__v690NonCriticalExtensions__v6b0NonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions, vaxyNonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_vaxyNonCriticalExtensions_22,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"vaxyNonCriticalExtensions"
...
static asn_TYPE_tag2member_t asn_MAP_v860NonCriticalExtensions_tag2el_20[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellUpdate-v860ext at 1457 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* vaxyNonCriticalExtensions at 1459 */
};
...
static asn_TYPE_tag2member_t asn_MAP_v770NonCriticalExtensions_tag2el_18[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellUpdate-v770ext at 1455 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v860NonCriticalExtensions at 1457 */
};
...
static asn_TYPE_tag2member_t asn_MAP_v6b0NonCriticalExtensions_tag2el_16[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellUpdate-v6b0ext at 1453 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v770NonCriticalExtensions at 1455 */
};
...
static asn_TYPE_tag2member_t asn_MAP_v690NonCriticalExtensions_tag2el_14[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellUpdate-v690ext at 1451 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v6b0NonCriticalExtensions at 1453 */
};
...
static asn_TYPE_tag2member_t asn_MAP_v590NonCriticalExtensions_tag2el_12[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellUpdate-v590ext at 1449 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v690NonCriticalExtensions at 1451 */
};
...
static asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_10[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellUpdate-r3-add-ext at 1447 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v590NonCriticalExtensions at 1449 */
};
...
static asn_TYPE_tag2member_t asn_MAP_CellUpdate_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* u-RNTI at 1434 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* startList at 1435 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* am-RLC-ErrorIndicationRb2-3or4 at 1436 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* am-RLC-ErrorIndicationRb5orAbove at 1437 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* cellUpdateCause at 1438 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* failureCause at 1440 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* rb-timer-indicator at 1441 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* measuredResultsOnRACH at 1443 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* laterNonCriticalExtensions at 1447 */
};
