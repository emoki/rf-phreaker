...
#include "rf_phreaker/umts_rrc_asn_library/TFCI-Range.h"
...
static asn_TYPE_tag2member_t asn_MAP_TFCI_Range_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* maxTFCIField2Value at 15640 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tfcs-InfoForDSCH at 15642 */
};
