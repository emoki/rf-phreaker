...
#include "rf_phreaker/umts_rrc_asn_library/CompressedModeMeasCapabTDD.h"
...
static asn_TYPE_tag2member_t asn_MAP_CompressedModeMeasCapabTDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* radioFrequencyBandTDD at 11449 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dl-MeasurementsTDD at 11450 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ul-MeasurementsTDD at 11451 */
};
