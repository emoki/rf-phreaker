...
#include "rf_phreaker/umts_rrc_asn_library/RAT-TDD-Info.h"
...
static asn_TYPE_tag2member_t asn_MAP_RAT_TDD_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rat-Identifier at 11177 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* s-SearchRAT at 11178 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* s-HCS-RAT at 11179 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* s-Limit-SearchRAT at 11181 */
};
