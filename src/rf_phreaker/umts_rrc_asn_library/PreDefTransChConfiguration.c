...
static asn_TYPE_tag2member_t asn_MAP_PreDefTransChConfiguration_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-CommonTransChInfo at 15556 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ul-AddReconfTrChInfoList at 15557 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* dl-CommonTransChInfo at 15558 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* dl-TrChInfoList at 15560 */
};
