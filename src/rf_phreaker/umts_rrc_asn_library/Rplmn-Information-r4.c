...
static asn_TYPE_tag2member_t asn_MAP_Rplmn_Information_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* gsm-BA-Range-List at 29134 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* fdd-UMTS-Frequency-List at 29135 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* tdd384-UMTS-Frequency-List at 29138 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* tdd128-UMTS-Frequency-List at 29139 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* cdma2000-UMTS-Frequency-List at 29140 */
};
