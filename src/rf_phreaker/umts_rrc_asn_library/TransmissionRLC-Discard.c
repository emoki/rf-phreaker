...
static asn_TYPE_tag2member_t asn_MAP_TransmissionRLC_Discard_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* timerBasedExplicit at 14702 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* timerBasedNoExplicit at 14703 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* maxDAT-Retransmissions at 14704 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* noDiscard at 14706 */
};
