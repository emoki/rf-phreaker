...
#include "rf_phreaker/umts_rrc_asn_library/DL-TrCH-TypeId2-r7.h"
...
static asn_TYPE_tag2member_t asn_MAP_hsdsch_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mac-hs at 15239 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* mac-ehs at 15241 */
};
...
static asn_TYPE_tag2member_t asn_MAP_DL_TrCH_TypeId2_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dch at 15234 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dsch at 15237 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* hsdsch at 15239 */
};
