...
#include "rf_phreaker/umts_rrc_asn_library/NewInterFreqCellSI-RSCP-LCR-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_NewInterFreqCellSI_RSCP_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* interFreqCellID at 26176 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* frequencyInfo at 26177 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cellInfo at 26179 */
};
