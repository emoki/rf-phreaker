...
#include "rf_phreaker/umts_rrc_asn_library/CN-DomainSysInfo.h"
...
static asn_TYPE_tag2member_t asn_MAP_cn_Type_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* gsm-MAP at 10773 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ansi-41 at 10775 */
};
...
static asn_TYPE_tag2member_t asn_MAP_CN_DomainSysInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cn-DomainIdentity at 10771 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cn-Type at 10773 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cn-DRX-CycleLengthCoeff at 10777 */
};
