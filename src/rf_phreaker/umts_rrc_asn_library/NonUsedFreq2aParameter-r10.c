...
#include "rf_phreaker/umts_rrc_asn_library/NonUsedFreq2aParameter-r10.h"
...
static asn_TYPE_member_t asn_MBR_NonUsedFreq2aParameter_r10_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NonUsedFreq2aParameter_r10, nonUsedFreqTriggeringConditionDetectedCells),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_tag2member_t asn_MAP_NonUsedFreq2aParameter_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nonUsedFreqW at 26417 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonUsedFreqTriggeringConditionDetectedCells at 26418 */
};
