...
#include "rf_phreaker/umts_rrc_asn_library/MBMS-ServiceSchedulingInfo-r6.h"
...
static asn_TYPE_tag2member_t asn_MAP_MBMS_ServiceSchedulingInfo_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mbms-TransmissionIdentity at 30956 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* mbms-ServiceTransmInfoList at 30957 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nextSchedulingperiod at 30958 */
};
