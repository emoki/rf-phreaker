...
#include "rf_phreaker/umts_rrc_asn_library/QualityReportCriteria.h"
...
static asn_TYPE_tag2member_t asn_MAP_QualityReportCriteria_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* qualityReportingCriteria at 26584 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* periodicalReportingCriteria at 26585 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* noReporting at 26586 */
};
