...
static asn_TYPE_tag2member_t asn_MAP_supported_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* maxNoSCCPCH-RL at 12629 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* simultaneousSCCPCH-DPCH-DPDCH-Reception at 12634 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SimultaneousSCCPCH_DPCH_Reception_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* notSupported at 12627 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* supported at 12629 */
};
