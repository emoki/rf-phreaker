...
#include "rf_phreaker/umts_rrc_asn_library/CellSelectReselectInfoTreselectionScaling-v5c0ext.h"
...
static asn_TYPE_tag2member_t asn_MAP_CellSelectReselectInfoTreselectionScaling_v5c0ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* non-HCS-t-CR-Max at 22737 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* speedDependentScalingFactor at 22738 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* interFrequencyTreselectionScalingFactor at 22739 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* interRATTreselectionScalingFactor at 22740 */
};
