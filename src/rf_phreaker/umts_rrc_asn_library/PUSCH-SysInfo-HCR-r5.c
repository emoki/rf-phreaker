...
#include "rf_phreaker/umts_rrc_asn_library/PUSCH-SysInfo-HCR-r5.h"
...
static asn_TYPE_tag2member_t asn_MAP_PUSCH_SysInfo_HCR_r5_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pusch-Identity at 20111 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pusch-Info at 20112 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* usch-TransportChannelsInfo at 20113 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* usch-TFCS at 20114 */
};
