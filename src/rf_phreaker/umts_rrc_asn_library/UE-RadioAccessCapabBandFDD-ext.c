...
#include "rf_phreaker/umts_rrc_asn_library/UE-RadioAccessCapabBandFDD-ext.h"
...
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapabBandFDD_ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* radioFrequencyBandFDD at 13277 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* compressedModeMeasCapabFDDList-ext at 13279 */
};
