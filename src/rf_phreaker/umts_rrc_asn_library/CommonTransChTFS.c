...
#include "rf_phreaker/umts_rrc_asn_library/CommonTransChTFS.h"
...
static asn_TYPE_tag2member_t asn_MAP_tti_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tti10 at 14992 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tti20 at 14993 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* tti40 at 14994 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* tti80 at 14995 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* dynamic at 14997 */
};
...
static asn_TYPE_tag2member_t asn_MAP_CommonTransChTFS_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tti at 14992 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* semistaticTF-Information at 14999 */
};
