...
static asn_TYPE_tag2member_t asn_MAP_fachCarryingMCCH_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mcch-transportFormatSet at 20504 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* mcch-ConfigurationInfo at 20506 */
};
...
static asn_TYPE_tag2member_t asn_MAP_fachCarryingMSCH_tag2el_8[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* msch-transportFormatSet at 20511 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SCCPCH_SystemInformation_MBMS_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondaryCCPCHInfo-MBMS at 20501 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* transportFormatCombinationSet at 20502 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* fachCarryingMCCH at 20504 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* fachCarryingMTCH-List at 20507 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* fachCarryingMSCH at 20511 */
};
