...
static asn_TYPE_member_t asn_MBR_ETWSPrimaryNotificationWithSecurity_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct ETWSPrimaryNotificationWithSecurity, etws_WarningSecurityInfo),
...
static asn_TYPE_tag2member_t asn_MAP_ETWSPrimaryNotificationWithSecurity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* etws-Information at 2441 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* etws-WarningSecurityInfo at 2442 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtensions at 2444 */
};
