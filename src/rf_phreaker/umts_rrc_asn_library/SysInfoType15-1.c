...
#include "rf_phreaker/umts_rrc_asn_library/SysInfoType15-1.h"
...
static asn_TYPE_tag2member_t asn_MAP_v920NonCriticalExtensions_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sysInfoType15-1-v920ext at 30164 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 30165 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SysInfoType15_1_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-positioning-GPS-DGPS-Corrections at 30161 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v920NonCriticalExtensions at 30164 */
};
