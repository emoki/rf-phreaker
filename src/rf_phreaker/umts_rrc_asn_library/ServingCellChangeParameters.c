...
static asn_TYPE_tag2member_t asn_MAP_ServingCellChangeParameters_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* servingCellChangeMACreset at 20706 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* servingCellChangeMsgType at 20707 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* servingCellChangeTrId at 20709 */
};
