...
#include "rf_phreaker/umts_rrc_asn_library/UEInformationResponse.h"
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_4 = {
	sizeof(struct UEInformationResponse__nonCriticalExtensions),
	offsetof(struct UEInformationResponse__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_UEInformationResponse_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct UEInformationResponse, loggedMeasReport),
	...
	{ ATF_POINTER, 1, offsetof(struct UEInformationResponse, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static int asn_MAP_UEInformationResponse_oms_1[] = { 1, 2 };
...
static asn_TYPE_tag2member_t asn_MAP_UEInformationResponse_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrc-TransactionIdentifier at 10546 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* loggedMeasReport at 10547 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtensions at 10548 */
};
