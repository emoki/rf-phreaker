...
#include "rf_phreaker/umts_rrc_asn_library/InterFreqCellInfoSI-List-HCS-ECN0.h"
...
static asn_TYPE_tag2member_t asn_MAP_InterFreqCellInfoSI_List_HCS_ECN0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* removedInterFreqCellList at 24185 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* newInterFreqCellList at 24186 */
};
