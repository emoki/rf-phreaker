...
#include "rf_phreaker/umts_rrc_asn_library/MeasurementCommandWithType-r8.h"
...
static asn_TYPE_tag2member_t asn_MAP_MeasurementCommandWithType_r8_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* setup at 32858 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* modify at 32859 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* release at 32860 */
};
