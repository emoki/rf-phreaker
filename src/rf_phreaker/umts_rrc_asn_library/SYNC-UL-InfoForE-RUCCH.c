...
static asn_TYPE_tag2member_t asn_MAP_SYNC_UL_InfoForE_RUCCH_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* prxUpPCHdes at 20866 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* powerRampStep at 20867 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* max-SYNC-UL-Transmissions at 20868 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* e-RUCCH-Sync-UL-Codes-Bitmap at 20869 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* mmax at 20870 */
};
