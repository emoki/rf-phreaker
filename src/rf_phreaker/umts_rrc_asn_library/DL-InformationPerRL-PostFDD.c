...
#include "rf_phreaker/umts_rrc_asn_library/DL-InformationPerRL-PostFDD.h"
...
static asn_TYPE_tag2member_t asn_MAP_DL_InformationPerRL_PostFDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCPICH-Info at 17309 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dl-DPCH-InfoPerRL at 17311 */
};
