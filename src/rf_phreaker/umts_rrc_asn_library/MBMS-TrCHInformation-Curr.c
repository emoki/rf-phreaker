...
#include "rf_phreaker/umts_rrc_asn_library/MBMS-TrCHInformation-Curr.h"
...
static asn_TYPE_tag2member_t asn_MAP_MBMS_TrCHInformation_Curr_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transpCh-Info at 31016 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rbInformation at 31017 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* msch-ConfigurationInfo at 31018 */
};
