...
static asn_TYPE_tag2member_t asn_MAP_HCS_NeighbouringCellInformation_RSCP_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* hcs-PRIO at 24056 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* q-HCS at 24057 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* hcs-CellReselectInformation at 24059 */
};
