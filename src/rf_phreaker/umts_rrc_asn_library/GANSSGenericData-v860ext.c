...
static asn_TYPE_tag2member_t asn_MAP_GANSSGenericData_v860ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uePositiningGANSSsbasID at 23594 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* uePositioningGANSSAddNavigationModels at 23596 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* uePositioningGANSSAlmanac at 23597 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* uePositioningGANSSAddUTCModels at 23598 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* uePositioningGANSSAuxiliaryInfo at 23599 */
};
