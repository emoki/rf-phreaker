...
#include "rf_phreaker/umts_rrc_asn_library/GANSS-SAT-Info-Almanac-REDkp.h"
...
static asn_TYPE_tag2member_t asn_MAP_GANSS_SAT_Info_Almanac_REDkp_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* svID at 23874 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* redAlmDeltaA at 23875 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* redAlmOmega0 at 23876 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* redAlmPhi0 at 23877 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* redAlmL1Health at 23878 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* redAlmL2Health at 23879 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* redAlmL5Health at 23880 */
};
