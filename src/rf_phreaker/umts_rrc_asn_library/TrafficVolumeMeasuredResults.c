...
#include "rf_phreaker/umts_rrc_asn_library/TrafficVolumeMeasuredResults.h"
...
static asn_TYPE_tag2member_t asn_MAP_TrafficVolumeMeasuredResults_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rb-Identity at 27060 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rlc-BuffersPayload at 27061 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* averageRLC-BufferPayload at 27062 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* varianceOfRLC-BufferPayload at 27063 */
};
