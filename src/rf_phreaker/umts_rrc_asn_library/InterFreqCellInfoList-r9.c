...
#include "rf_phreaker/umts_rrc_asn_library/InterFreqCellInfoList-r9.h"
...
static asn_TYPE_tag2member_t asn_MAP_InterFreqCellInfoList_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* removedInterFreqCellList at 24144 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* newInterFreqCellList at 24145 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* cellsForInterFreqMeasList at 24146 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* cSGInterFreqCellInfoList at 24147 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* interFreqSIAcquisition at 24148 */
};
