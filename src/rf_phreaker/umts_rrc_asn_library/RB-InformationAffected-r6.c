...
#include "rf_phreaker/umts_rrc_asn_library/RB-InformationAffected-r6.h"
...
static asn_TYPE_tag2member_t asn_MAP_RB_InformationAffected_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rb-Identity at 14208 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* rb-MappingInfo at 14210 */
};
