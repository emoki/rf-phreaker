...
#include "rf_phreaker/umts_rrc_asn_library/SysInfoType13-3.h"
...
static asn_TYPE_tag2member_t asn_MAP_SysInfoType13_3_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ansi-41-PrivateNeighbourListInfo at 30077 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 30079 */
};
