...
static asn_TYPE_tag2member_t asn_MAP_Multi_frequencyInfo_LCR_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondFrequencyInfo at 19270 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* fPachFrequencyInfo at 19271 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* upPCHpositionInfo at 19273 */
};
