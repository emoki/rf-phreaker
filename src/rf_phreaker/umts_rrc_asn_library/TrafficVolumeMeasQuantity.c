...
static asn_TYPE_tag2member_t asn_MAP_TrafficVolumeMeasQuantity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rlc-BufferPayload at 27040 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* averageRLC-BufferPayload at 27041 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* varianceOfRLC-BufferPayload at 27043 */
};
