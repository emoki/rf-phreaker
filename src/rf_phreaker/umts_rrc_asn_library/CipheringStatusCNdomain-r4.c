...
#include "rf_phreaker/umts_rrc_asn_library/CipheringStatusCNdomain-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_CipheringStatusCNdomain_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cn-DomainIdentity at 32686 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cipheringStatus at 32687 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* start-Value at 32689 */
};
