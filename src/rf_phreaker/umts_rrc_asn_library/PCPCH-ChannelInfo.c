...
static asn_TYPE_tag2member_t asn_MAP_PCPCH_ChannelInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pcpch-UL-ScramblingCode at 19420 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pcpch-DL-ChannelisationCode at 19421 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* pcpch-DL-ScramblingCode at 19422 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* pcp-Length at 19423 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* ucsm-Info at 19424 */
};
