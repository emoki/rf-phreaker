...
static asn_TYPE_tag2member_t asn_MAP_Common_MAC_ehs_ReorderingQueue_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mac-ehs-QueueId at 15014 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* t1-ReleaseTimer at 15015 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* reorderingResetTimer at 15016 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* mac-ehsWindowSize at 15018 */
};
