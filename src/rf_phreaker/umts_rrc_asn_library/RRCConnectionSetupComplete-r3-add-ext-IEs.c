...
#include "rf_phreaker/umts_rrc_asn_library/RRCConnectionSetupComplete-r3-add-ext-IEs.h"
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_11 = {
	sizeof(struct RRCConnectionSetupComplete_r3_add_ext_IEs__v680NonCriticalExtensions__v7e0NonCriticalExtensions__v7f0NonCriticalExtensions__vaxyNonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct RRCConnectionSetupComplete_r3_add_ext_IEs__v680NonCriticalExtensions__v7e0NonCriticalExtensions__v7f0NonCriticalExtensions__vaxyNonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_vaxyNonCriticalExtensions_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionSetupComplete_r3_add_ext_IEs__v680NonCriticalExtensions__v7e0NonCriticalExtensions__v7f0NonCriticalExtensions__vaxyNonCriticalExtensions, rrcConnectionSetupComplete_vaxyext),
		...
		0,	/* No PER visible constraints */
		0,
		"rrcConnectionSetupComplete-vaxyext"
		},
	{ ATF_POINTER, 1, offsetof(struct RRCConnectionSetupComplete_r3_add_ext_IEs__v680NonCriticalExtensions__v7e0NonCriticalExtensions__v7f0NonCriticalExtensions__vaxyNonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static int asn_MAP_vaxyNonCriticalExtensions_oms_9[] = { 1 };
static ber_tlv_tag_t asn_DEF_vaxyNonCriticalExtensions_tags_9[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_vaxyNonCriticalExtensions_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupComplete-vaxyext at 8249 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 8250 */
};
static asn_SEQUENCE_specifics_t asn_SPC_vaxyNonCriticalExtensions_specs_9 = {
	sizeof(struct RRCConnectionSetupComplete_r3_add_ext_IEs__v680NonCriticalExtensions__v7e0NonCriticalExtensions__v7f0NonCriticalExtensions__vaxyNonCriticalExtensions),
	offsetof(struct RRCConnectionSetupComplete_r3_add_ext_IEs__v680NonCriticalExtensions__v7e0NonCriticalExtensions__v7f0NonCriticalExtensions__vaxyNonCriticalExtensions, _asn_ctx),
	asn_MAP_vaxyNonCriticalExtensions_tag2el_9,
	2,	/* Count of tags in the map */
	asn_MAP_vaxyNonCriticalExtensions_oms_9,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_vaxyNonCriticalExtensions_9 = {
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_vaxyNonCriticalExtensions_tags_9,
	sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_9)
		/sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_9[0]) - 1, /* 1 */
	asn_DEF_vaxyNonCriticalExtensions_tags_9,	/* Same as above */
	sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_9)
		/sizeof(asn_DEF_vaxyNonCriticalExtensions_tags_9[0]), /* 2 */
	0,	/* No PER visible constraints */
	asn_MBR_vaxyNonCriticalExtensions_9,
	2,	/* Elements count */
	&asn_SPC_vaxyNonCriticalExtensions_specs_9	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_v7f0NonCriticalExtensions_7[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RRCConnectionSetupComplete_r3_add_ext_IEs__v680NonCriticalExtensions__v7e0NonCriticalExtensions__v7f0NonCriticalExtensions, vaxyNonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_vaxyNonCriticalExtensions_9,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"vaxyNonCriticalExtensions"
...
static asn_TYPE_tag2member_t asn_MAP_v7f0NonCriticalExtensions_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupComplete-v7f0ext at 8246 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* vaxyNonCriticalExtensions at 8249 */
};
...
static asn_TYPE_tag2member_t asn_MAP_v7e0NonCriticalExtensions_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupComplete-v7e0ext at 8243 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v7f0NonCriticalExtensions at 8246 */
};
...
static asn_TYPE_tag2member_t asn_MAP_v680NonCriticalExtensions_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupComplete-v680ext at 8241 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v7e0NonCriticalExtensions at 8243 */
};
...
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionSetupComplete_r3_add_ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionSetupComplete-v650ext at 8239 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v680NonCriticalExtensions at 8241 */
};
