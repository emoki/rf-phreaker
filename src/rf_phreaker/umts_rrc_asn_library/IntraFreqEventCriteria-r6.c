...
#include "rf_phreaker/umts_rrc_asn_library/IntraFreqEventCriteria-r6.h"
...
static asn_TYPE_tag2member_t asn_MAP_IntraFreqEventCriteria_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* event at 24940 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* hysteresis at 24941 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* timeToTrigger at 24942 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* reportingCellStatus at 24943 */
};
