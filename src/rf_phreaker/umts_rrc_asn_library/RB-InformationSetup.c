...
#include "rf_phreaker/umts_rrc_asn_library/RB-InformationSetup.h"
...
static asn_TYPE_tag2member_t asn_MAP_RB_InformationSetup_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rb-Identity at 14324 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pdcp-Info at 14325 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* rlc-InfoChoice at 14326 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* rb-MappingInfo at 14328 */
};
