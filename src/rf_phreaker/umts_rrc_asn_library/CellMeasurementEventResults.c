...
#include "rf_phreaker/umts_rrc_asn_library/CellMeasurementEventResults.h"
...
static asn_TYPE_tag2member_t asn_MAP_CellMeasurementEventResults_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd at 22573 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd at 22576 */
};
