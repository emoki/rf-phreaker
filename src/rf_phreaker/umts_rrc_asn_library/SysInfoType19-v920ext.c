...
static asn_TYPE_tag2member_t asn_MAP_SysInfoType19_v920ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* utra-PriorityInfoList-v920ext at 30428 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* eutra-FrequencyAndPriorityInfoList-v920ext at 30430 */
};
