...
#include "rf_phreaker/umts_rrc_asn_library/InterRATCellInfoList-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_InterRATCellInfoList_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* removedInterRATCellList at 24570 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* newInterRATCellList at 24571 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cellsForInterRATMeasList at 24572 */
};
