...
#include "rf_phreaker/umts_rrc_asn_library/DL-HSPDSCH-Information-r8-ext.h"
...
static asn_TYPE_tag2member_t asn_MAP_tdd128_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* outofSyncWindow at 17042 */
};
...
static asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tdd384 at 17039 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tdd768 at 17040 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* tdd128 at 17042 */
};
...
static asn_TYPE_tag2member_t asn_MAP_modeSpecificInfo_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tdd at 17039 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* fdd at 17045 */
};
...
static asn_TYPE_tag2member_t asn_MAP_DL_HSPDSCH_Information_r8_ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* modeSpecificInfo at 17044 */
};
