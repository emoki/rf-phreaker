...
#include "rf_phreaker/umts_rrc_asn_library/UL-AddReconfTransChInformation.h"
...
static asn_TYPE_tag2member_t asn_MAP_UL_AddReconfTransChInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-TransportChannelType at 15767 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* transportChannelIdentity at 15768 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* transportFormatSet at 15770 */
};
