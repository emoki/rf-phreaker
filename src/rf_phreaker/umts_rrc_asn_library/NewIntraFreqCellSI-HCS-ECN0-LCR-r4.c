...
#include "rf_phreaker/umts_rrc_asn_library/NewIntraFreqCellSI-HCS-ECN0-LCR-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_NewIntraFreqCellSI_HCS_ECN0_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqCellID at 26366 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellInfo at 26368 */
};
