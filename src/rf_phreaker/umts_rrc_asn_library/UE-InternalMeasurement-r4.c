...
static asn_TYPE_tag2member_t asn_MAP_UE_InternalMeasurement_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-InternalMeasQuantity at 27258 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ue-InternalReportingQuantity at 27259 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* reportCriteria at 27261 */
};
