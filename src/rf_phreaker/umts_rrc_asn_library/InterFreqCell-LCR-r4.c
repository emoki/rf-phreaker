...
#include "rf_phreaker/umts_rrc_asn_library/InterFreqCell-LCR-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_InterFreqCell_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* frequencyInfo at 24119 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonFreqRelatedEventResults at 24121 */
};
