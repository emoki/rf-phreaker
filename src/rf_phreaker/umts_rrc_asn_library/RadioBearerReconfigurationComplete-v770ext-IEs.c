...
#include "rf_phreaker/umts_rrc_asn_library/RadioBearerReconfigurationComplete-v770ext-IEs.h"
...
static asn_TYPE_tag2member_t asn_MAP_RadioBearerReconfigurationComplete_v770ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ext-UL-TimingAdvance at 5673 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* deferredMeasurementControlReading at 5674 */
};
