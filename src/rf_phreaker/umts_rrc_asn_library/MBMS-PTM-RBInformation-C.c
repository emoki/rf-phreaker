...
static asn_TYPE_tag2member_t asn_MAP_MBMS_PTM_RBInformation_C_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rbInformation at 30873 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* shortTransmissionID at 30874 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* logicalChIdentity at 30876 */
};
