...
#include "rf_phreaker/umts_rrc_asn_library/FACH-PCH-Information.h"
...
static asn_TYPE_tag2member_t asn_MAP_FACH_PCH_Information_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transportFormatSet at 18329 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* transportChannelIdentity at 18330 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ctch-Indicator at 18331 */
};
