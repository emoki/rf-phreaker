...
static asn_TYPE_tag2member_t asn_MAP_supported_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* edch-PhysicalLayerCategory at 13542 */
};
...
static asn_TYPE_tag2member_t asn_MAP_fdd_edch_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supported at 13543 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* unsupported at 13544 */
};
...
static asn_TYPE_tag2member_t asn_MAP_PhysicalChannelCapability_edch_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* fdd-edch at 13543 */
};
