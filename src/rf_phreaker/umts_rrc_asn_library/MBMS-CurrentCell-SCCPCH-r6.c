...
static asn_TYPE_tag2member_t asn_MAP_MBMS_CurrentCell_SCCPCH_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sccpchIdentity at 30561 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* secondaryCCPCH-Info at 30562 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* softComb-TimingOffset at 30563 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* transpCh-InfoCommonForAllTrCh at 30566 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* transpCHInformation at 30568 */
};
