...
static asn_TYPE_tag2member_t asn_MAP_UL_EDCH_Information_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mac-es-e-resetIndicator at 21814 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* e-DPCCH-Info at 21815 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* e-DPDCH-Info at 21816 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* schedulingTransmConfiguration at 21817 */
};
