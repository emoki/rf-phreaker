...
#include "rf_phreaker/umts_rrc_asn_library/DRAC-StaticInformation.h"
...
static asn_TYPE_tag2member_t asn_MAP_DRAC_StaticInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transmissionTimeValidity at 15247 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* timeDurationBeforeRetry at 15248 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* drac-ClassIdentity at 15250 */
};
