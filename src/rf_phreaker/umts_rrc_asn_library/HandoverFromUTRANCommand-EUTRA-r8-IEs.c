...
static asn_TYPE_tag2member_t asn_MAP_HandoverFromUTRANCommand_EUTRA_r8_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* activationTime at 3325 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* toHandoverRAB-Info at 3327 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* eutra-Message at 3329 */
};
