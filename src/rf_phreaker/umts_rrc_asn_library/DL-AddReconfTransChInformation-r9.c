...
#include "rf_phreaker/umts_rrc_asn_library/DL-AddReconfTransChInformation-r9.h"
...
static asn_TYPE_tag2member_t asn_MAP_tfs_SignallingMode_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* explicit-config at 15136 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* sameAsULTrCH at 15137 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* hsdsch at 15139 */
};
...
static asn_TYPE_tag2member_t asn_MAP_DL_AddReconfTransChInformation_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-TransportChannelType at 15134 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tfs-SignallingMode at 15136 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dch-QualityTarget at 15140 */
};
