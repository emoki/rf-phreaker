...
static asn_TYPE_tag2member_t asn_MAP_IntraFreqReportingQuantity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* activeSetReportingQuantities at 25169 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* monitoredSetReportingQuantities at 25170 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* detectedSetReportingQuantities at 25171 */
};
