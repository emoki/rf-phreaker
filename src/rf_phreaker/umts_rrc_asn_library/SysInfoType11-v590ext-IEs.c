...
static asn_TYPE_tag2member_t asn_MAP_SysInfoType11_v590ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* newIntraFrequencyCellInfoList-v590ext at 29905 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* newInterFrequencyCellInfoList-v590ext at 29908 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* newInterRATCellInfoList-v590ext at 29911 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* intraFreqEventCriteriaList-v590ext at 29912 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* intraFreqReportingCriteria-1b-r5 at 29913 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* intraFreqEvent-1d-r5 at 29914 */
};
