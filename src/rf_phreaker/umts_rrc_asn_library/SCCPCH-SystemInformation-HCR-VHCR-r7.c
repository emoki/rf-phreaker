...
#include "rf_phreaker/umts_rrc_asn_library/SCCPCH-SystemInformation-HCR-VHCR-r7.h"
...
static asn_TYPE_tag2member_t asn_MAP_SCCPCH_SystemInformation_HCR_VHCR_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondaryCCPCH-Info at 20462 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tfcs at 20463 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* fach-PCH-InformationList at 20464 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* pich-Info at 20465 */
};
