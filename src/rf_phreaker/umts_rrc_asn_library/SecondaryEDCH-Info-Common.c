...
static asn_TYPE_tag2member_t asn_MAP_servingGrant_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* primary-Secondary-GrantSelector at 12578 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SecondaryEDCH_Info_Common_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* frequencyInfo at 12573 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* scramblingCodeType at 12574 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* scramblingCodeNumber at 12575 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* ms2-SchedTransmGrantHARQAlloc at 12576 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* servingGrant at 12579 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* minReduced-E-DPDCH-GainFactor at 12580 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* e-DCH-minimumSet-E-TFCI at 12581 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* dpcchPowerOffset-SecondaryULFrequency at 12582 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* pc-Preamble at 12584 */
};
