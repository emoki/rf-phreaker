...
static asn_TYPE_tag2member_t asn_MAP_RLC_Capability_r5_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* totalRLC-AM-BufferSize at 33075 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* maximumRLC-WindowSize at 33076 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* maximumAM-EntityNumber at 33078 */
};
