...
#include "rf_phreaker/umts_rrc_asn_library/DRAC-SysInfo.h"
...
static asn_TYPE_tag2member_t asn_MAP_DRAC_SysInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* transmissionProbability at 11610 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* maximumBitRate at 11612 */
};
