...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_13 = {
	sizeof(struct URAUpdate__laterNonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct URAUpdate__laterNonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_vaxyNonCriticalExtensions_11[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct URAUpdate__laterNonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions, uraUpdate_vaxyext),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_URAUpdate_vaxyext_IEs,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"uraUpdate-vaxyext"
		},
	{ ATF_POINTER, 1, offsetof(struct URAUpdate__laterNonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_vaxyNonCriticalExtensions_tag2el_11[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uraUpdate-vaxyext at 9877 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 9878 */
};
static asn_SEQUENCE_specifics_t asn_SPC_vaxyNonCriticalExtensions_specs_11 = {
	sizeof(struct URAUpdate__laterNonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions),
	offsetof(struct URAUpdate__laterNonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions__vaxyNonCriticalExtensions, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_v860NonCriticalExtensions_9[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct URAUpdate__laterNonCriticalExtensions__v770NonCriticalExtensions__v860NonCriticalExtensions, vaxyNonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_v860NonCriticalExtensions_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uraUpdate-v860ext at 9875 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* vaxyNonCriticalExtensions at 9877 */
};
...
static asn_TYPE_tag2member_t asn_MAP_v770NonCriticalExtensions_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uraUpdate-v770ext at 9873 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v860NonCriticalExtensions at 9875 */
};
...
static asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* uraUpdate-r3-add-ext at 9871 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* v770NonCriticalExtensions at 9873 */
};
...
static asn_TYPE_tag2member_t asn_MAP_URAUpdate_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* u-RNTI at 9865 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ura-UpdateCause at 9866 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* protocolErrorIndicator at 9867 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* laterNonCriticalExtensions at 9871 */
};
