...
#include "rf_phreaker/umts_rrc_asn_library/UE-RadioAccessCapabilityComp2.h"
...
static asn_TYPE_tag2member_t asn_MAP_fddPhysicalChannelCapab_hspdsch_edch_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-CapabilityWithSimultaneousHS-DSCHConfig at 13329 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* physicalChannelCapabComp-hspdsch-r6 at 13330 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* physicalChannelCapability-edch-r6 at 13332 */
};
...
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapabilityComp2_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* fddPhysicalChannelCapab-hspdsch-edch at 13329 */
};
