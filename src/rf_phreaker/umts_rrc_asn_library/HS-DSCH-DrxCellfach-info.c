...
static asn_TYPE_tag2member_t asn_MAP_HS_DSCH_DrxCellfach_info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* t-321 at 18413 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* hs-dsch-DrxCycleFach at 18414 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* hs-dsch-DrxBurstFach at 18415 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* drxInterruption-hs-dsch at 18416 */
};
