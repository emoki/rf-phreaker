...
#include "rf_phreaker/umts_rrc_asn_library/MBMS-ServiceTransmInfo.h"
...
static asn_TYPE_tag2member_t asn_MAP_MBMS_ServiceTransmInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* start at 30966 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* duration at 30967 */
};
