...
#include "rf_phreaker/umts_rrc_asn_library/TrafficVolumeEventParam.h"
...
static asn_TYPE_tag2member_t asn_MAP_TrafficVolumeEventParam_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eventID at 27023 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* reportingThreshold at 27024 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* timeToTrigger at 27025 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* pendingTimeAfterTrigger at 27026 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* tx-InterruptionAfterTrigger at 27027 */
};
