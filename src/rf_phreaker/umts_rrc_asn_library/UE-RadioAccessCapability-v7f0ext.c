...
#include "rf_phreaker/umts_rrc_asn_library/UE-RadioAccessCapability-v7f0ext.h"
...
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapability_v7f0ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportofTxDivOnNonMIMOChannel at 13135 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* physicalChannelCapability-LCR at 13138 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ue-RadioAccessCapabilityComp-TDD128 at 13139 */
};
