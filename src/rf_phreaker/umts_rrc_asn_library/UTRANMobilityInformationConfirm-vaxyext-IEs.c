...
static asn_TYPE_member_t asn_MBR_UTRANMobilityInformationConfirm_vaxyext_IEs_1[] = {
	{ ATF_POINTER, 1, offsetof(struct UTRANMobilityInformationConfirm_vaxyext_IEs, loggedMeasAvailable),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static int asn_MAP_UTRANMobilityInformationConfirm_vaxyext_IEs_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UTRANMobilityInformationConfirm_vaxyext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* loggedMeasAvailable at 10224 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UTRANMobilityInformationConfirm_vaxyext_IEs_specs_1 = {
	sizeof(struct UTRANMobilityInformationConfirm_vaxyext_IEs),
	offsetof(struct UTRANMobilityInformationConfirm_vaxyext_IEs, _asn_ctx),
	asn_MAP_UTRANMobilityInformationConfirm_vaxyext_IEs_tag2el_1,
	1,	/* Count of tags in the map */
	asn_MAP_UTRANMobilityInformationConfirm_vaxyext_IEs_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs = {
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs_tags_1,
	sizeof(asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs_tags_1)
		/sizeof(asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs_tags_1[0]), /* 1 */
	asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs_tags_1)
		/sizeof(asn_DEF_UTRANMobilityInformationConfirm_vaxyext_IEs_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_UTRANMobilityInformationConfirm_vaxyext_IEs_1,
	1,	/* Elements count */
	&asn_SPC_UTRANMobilityInformationConfirm_vaxyext_IEs_specs_1	/* Additional specs */
};
