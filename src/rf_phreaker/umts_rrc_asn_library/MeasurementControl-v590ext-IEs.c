...
static asn_TYPE_tag2member_t asn_MAP_measurementCommand_v590ext_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intra-frequency at 3753 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* inter-frequency at 3755 */
};
...
static asn_TYPE_tag2member_t asn_MAP_MeasurementControl_v590ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measurementCommand-v590ext at 3753 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* intraFreqReportingCriteria-1b-r5 at 3756 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* intraFreqEvent-1d-r5 at 3757 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* rrc-TransactionIdentifier-MSP-v590ext at 3762 */
};
