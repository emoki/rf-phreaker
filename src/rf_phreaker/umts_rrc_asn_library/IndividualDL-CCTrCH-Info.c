...
#include "rf_phreaker/umts_rrc_asn_library/IndividualDL-CCTrCH-Info.h"
...
static asn_TYPE_tag2member_t asn_MAP_tfcs_SignallingMode_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* explicit-config at 15390 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* sameAsUL at 15392 */
};
...
static asn_TYPE_tag2member_t asn_MAP_IndividualDL_CCTrCH_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-TFCS-Identity at 15388 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tfcs-SignallingMode at 15390 */
};
