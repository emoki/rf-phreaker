...
#include "rf_phreaker/umts_rrc_asn_library/SynchronisationParameters-r4.h"
...
static asn_TYPE_tag2member_t asn_MAP_SynchronisationParameters_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sync-UL-CodesBitmap at 20825 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* fpach-Info at 20834 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* prxUpPCHdes at 20836 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* sync-UL-Procedure at 20837 */
};
