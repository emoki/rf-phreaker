...
#include "rf_phreaker/umts_rrc_asn_library/DSCH-Mapping.h"
...
static asn_TYPE_tag2member_t asn_MAP_DSCH_Mapping_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* maxTFCI-Field2Value at 17667 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* spreadingFactor at 17668 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* codeNumber at 17669 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* multiCodeInfo at 17671 */
};
