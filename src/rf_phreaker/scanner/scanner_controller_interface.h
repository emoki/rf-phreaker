...
public:
	...
	virtual std::future<measurement_info> get_rf_data(frequency_type freq, time_type time_ns, bandwidth_type bandwidth, int total_gain_db, frequency_type sampling_rate = 0) = 0;
